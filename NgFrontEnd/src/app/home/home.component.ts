...
@Component({
  selector: 'app-home',
  imports: [PosterComponent, CategoryComponent, BestSellingComponent, DiscountCouponsComponent, FeaturedComponent, DiscountPurchaseComponent, MostPopularComponent, JustArrivedComponent, AppDownloadComponent, LookingForComponent, ServicesComponent, FooterComponent],
