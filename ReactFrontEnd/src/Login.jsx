...
const LoginForm = () => {
  const apiUrl = 'http://localhost:3000/authentication/login'
  ...
  const navigate = useNavigate();
    ...
    const handleSubmit = (e) => {
      ...
      .catch(err => {
        ...
        // Show SweetAlert2 error popup on failure (network issues, etc.)
        Swal.fire({
          title: 'Oops!',
    ...
    return (
        <StyledWrapper>
            <form className="form" onSubmit={handleSubmit}>
                ...
                <p className="signin">Don't have an acount ? <Link className="nav-link" to="/register">Signup</Link> </p>
            </form>
        </StyledWrapper>
    );
}
