    ...
    <>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="banner-blocks">
                ...
                <div class="banner-ad d-flex align-items-center large bg-info block-1 discount1">
                ...
                <div class="banner-ad bg-success-subtle block-2 discount2">
                ...
                <div class="banner-ad bg-danger block-3 discount3">
                  <div class="banner-content align-items-center p-5">
                    <div class="content-wrapper text-light">
      ...
      <section>
        <div class="container-lg">
          ...
          <div class="bg-secondary text-light py-5 my-5 discount4">
            <div class="container">
