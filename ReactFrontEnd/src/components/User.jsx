    ...
    return (
        <div className="order-md-last">
            <div className="d-flex justify-content-center">
                {user.profile_picture ? <img src={user.profile_picture} style={{ borderRadius: "50%", objectFit: "cover" }} width="150" height="150"/> : <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" className="bi bi-person-circle" viewBox="0 0 16 16">
